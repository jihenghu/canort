"""
QNH surface model for CanORT.
This module provides the QNH (Quasi-Normal Height) surface scattering model.
"""
...
def qnh_model(
    ...
    """
    Calculate QNH surface scattering coefficients.
    ...
    roughness = np.exp(-2 * (k * h * np.cos(theta))**2)
