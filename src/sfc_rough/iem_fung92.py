"""
IEM Fung 1992 surface model for CanORT.
This module provides the Integral Equation Model (IEM) surface scattering model.
"""
...
def iem_fung92_model(
    ...
    """
    Calculate IEM Fung 1992 surface scattering coefficients.
