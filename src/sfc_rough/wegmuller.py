"""
Wegmuller surface model for CanORT.
This module provides the Wegmuller surface scattering model.
"""
...
def wegmuller_model(
    ...
    """
    Calculate Wegmuller surface scattering coefficients.
    ...
    roughness = np.exp(-4 * (k * h * np.cos(theta))**2)
