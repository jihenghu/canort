"""
Choudhury 1979 surface model for CanORT.
This module provides the Choudhury surface scattering model.
"""
...
def choudhury79_model(
    ...
    """
    Calculate Choudhury 1979 surface scattering coefficients.
    ...
    roughness = np.exp(-2 * (k * h * np.cos(theta))**2 * (1 - np.exp(-(l/h)**2)))
